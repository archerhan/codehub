...
class GitHubTrending {
  fetchTrending(url) async {
    var res = await httpManager.request(url, null, null, new Options(contentType: ContentType.text));
    if (res != null && res.result && res.data != null) {
      return new ResultData(TrendingUtil.htmlToRepo(res.data), true, StatusCode.SUCCESS);
    } else {
      return res;
    }
  }
